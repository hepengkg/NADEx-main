...
def get_freq(dataset):
    num_e, num_r = get_total_number('F:\code\TKG\DiffuTKG-main\data\{}'.format(dataset), 'stat.txt')
    train_data, train_times = load_quadruples('F:\code\TKG\DiffuTKG-main\data\{}'.format(dataset), 'train.txt', num_r)
    dev_data, dev_times = load_quadruples('F:\code\TKG\DiffuTKG-main\data\{}'.format(dataset), 'valid.txt', num_r)
    test_data, test_times = load_quadruples('F:\code\TKG\DiffuTKG-main\data\{}'.format(dataset), 'test.txt', num_r)
...
def main_fun():     
    ...
    #     get_freq(dataset)
    for dataset in ['ICEWS05-15', 'GDELT']:
        get_freq(dataset)
